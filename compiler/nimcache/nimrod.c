...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/usr/src/extras/Nimrod/lib -o compiler/nimcache/nimrod.o compiler/nimcache/nimrod.c */
...
N_NIMCALL(void, handlecmdline_428603)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_428401)(NimStringDesc* f);
...
N_NOINLINE(void, rltypedefsInit)(void);
N_NOINLINE(void, rltypedefsDatInit)(void);
...
STRING_LITERAL(TMP1302, "", 0);
STRING_LITERAL(TMP1474, "nimrod.cfg", 10);
STRING_LITERAL(TMP4196, "./", 2);
STRING_LITERAL(TMP4197, "js", 2);
STRING_LITERAL(TMP4198, "node ", 5);
...
extern NimStringDesc* arguments_424005;
...
appendString(LOC7, ((NimStringDesc*) &TMP4196));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_428603)(void) {
	{
		NI LOC3;
		LOC3 = paramcount_98433();
		if (!(LOC3 == 0)) goto LA4;
		writecommandlineusage_159002();
	}
	goto LA1;
	LA4: ;
	{
		processcmdline_424007(((NU8) 0), ((NimStringDesc*) &TMP1302));
		{
			TSafePoint TMP1303;
			TY94237 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1303);
			TMP1303.status = setjmp(TMP1303.context);
			if (TMP1303.status == 0) {
			...
			if (TMP1303.status != 0) reraiseException();
			chckNil((void*)&p);
		...
		LA7: ;
		loadconfigs_188454(((NimStringDesc*) &TMP1474));
		initvars_155646();
		processcmdline_424007(((NU8) 1), ((NimStringDesc*) &TMP1302));
		maincommand_426812();
		{
			NimStringDesc* LOC22;
			if (!(2 <= gverbosity_105116)) goto LA20;
			LOC22 = 0;
			LOC22 = gcgetstatistics_5821();
			printf("%s\012", (LOC22)->data);
		}
		LA20: ;
		{
			if (!(gerrorcounter_128868 == 0)) goto LA25;
			{
				if (!((gglobaloptions_105108 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LOC35 = 0;
					LOC35 = noschangeFileExt(gprojectfull_105193, ((NimStringDesc*) &TMP4197));
					LOC36 = 0;
					LOC36 = prependcurdir_428401(LOC35);
					LOC37 = 0;
					LOC37 = completecfilepath_155675(LOC36, NIM_TRUE);
					ex = quoteifcontainswhite_78720(LOC37);
					LOC38 = 0;
					LOC38 = rawNewString(ex->Sup.len + arguments_424005->Sup.len + 6);
appendString(LOC38, ((NimStringDesc*) &TMP4198));
appendString(LOC38, ex);
appendChar(LOC38, 32);
appendString(LOC38, arguments_424005);
					execexternalprogram_155707(LOC38);
				}
				goto LA31;
				LA33: ;
				{
					...
					NimStringDesc* LOC42;
					LOC40 = 0;
					LOC40 = noschangeFileExt(gprojectfull_105193, ((NimStringDesc*) &TMP1302));
					LOC41 = 0;
					LOC41 = prependcurdir_428401(LOC40);
					ex = quoteifcontainswhite_78720(LOC41);
					LOC42 = 0;
					LOC42 = rawNewString(ex->Sup.len + arguments_424005->Sup.len + 1);
appendString(LOC42, ex);
appendChar(LOC42, 32);
appendString(LOC42, arguments_424005);
					execexternalprogram_155707(LOC42);
				}
				LA31: ;
			}
			LA29: ;
...
N_NOINLINE(void, nimrodInit)(void) {
	gcdisablemarkandsweep_5819();
	initdefines_149135();
	handlecmdline_428603();
	exit(((NI) (((NI8) ((0 < gerrorcounter_128868))))));
}
