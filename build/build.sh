...
windows) 
  ...
  i386)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/1_1/guards.c -o build/1_1/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/1_1/guards.c -o build/1_1/guards.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/1_1/sequtils.c -o build/1_1/sequtils.o"
    $CC $COMP_FLAGS -Ibuild -c build/1_1/sequtils.c -o build/1_1/sequtils.o
...
build/1_1/docgen2.o \
build/1_1/service.o \
build/1_1/parseopt.o $LINK_FLAGS"
    $LINKER -o bin/nimrod  \
build/1_1/nimrod.o \
build/1_1/system.o \
build/1_1/commands.o \
...
build/1_1/parseopt.o $LINK_FLAGS
  ...
  amd64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/1_2/guards.c -o build/1_2/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/1_2/guards.c -o build/1_2/guards.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/1_2/sequtils.c -o build/1_2/sequtils.o"
    $CC $COMP_FLAGS -Ibuild -c build/1_2/sequtils.c -o build/1_2/sequtils.o
...
build/1_2/docgen2.o \
build/1_2/service.o \
build/1_2/parseopt.o $LINK_FLAGS"
    $LINKER -o bin/nimrod  \
build/1_2/nimrod.o \
build/1_2/system.o \
build/1_2/commands.o \
...
linux) 
  ...
  i386)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_1/guards.c -o build/2_1/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_1/guards.c -o build/2_1/guards.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_1/sequtils.c -o build/2_1/sequtils.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_1/sequtils.c -o build/2_1/sequtils.o
...
build/2_1/docgen2.o \
build/2_1/service.o \
build/2_1/parseopt.o $LINK_FLAGS"
    $LINKER -o bin/nimrod  \
build/2_1/nimrod.o \
build/2_1/system.o \
build/2_1/commands.o \
...
build/2_1/parseopt.o $LINK_FLAGS
  ...
  amd64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/guards.c -o build/2_2/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/guards.c -o build/2_2/guards.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/sequtils.c -o build/2_2/sequtils.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/sequtils.c -o build/2_2/sequtils.o
...
build/2_2/docgen2.o \
build/2_2/service.o \
build/2_2/parseopt.o $LINK_FLAGS"
    $LINKER -o bin/nimrod  \
build/2_2/nimrod.o \
build/2_2/system.o \
build/2_2/commands.o \
...
build/2_2/parseopt.o $LINK_FLAGS
  ...
  powerpc64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_3/times.c -o build/2_3/times.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_3/times.c -o build/2_3/times.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/posix.c -o build/2_2/posix.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/posix.c -o build/2_2/posix.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_3/guards.c -o build/2_3/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_3/guards.c -o build/2_3/guards.o
...
build/2_2/parseopt.o $LINK_FLAGS
  ...
  arm)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_4/times.c -o build/2_4/times.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_4/times.c -o build/2_4/times.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_1/posix.c -o build/2_1/posix.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_1/posix.c -o build/2_1/posix.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_4/guards.c -o build/2_4/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_4/guards.c -o build/2_4/guards.o
...
macosx) 
  ...
  i386)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/crc.c -o build/3_1/crc.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/crc.c -o build/3_1/crc.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_1/nversion.c -o build/2_1/nversion.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_1/nversion.c -o build/2_1/nversion.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/idents.c -o build/3_1/idents.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/idents.c -o build/3_1/idents.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/intsets.c -o build/3_1/intsets.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/intsets.c -o build/3_1/intsets.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/wordrecg.c -o build/3_1/wordrecg.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/wordrecg.c -o build/3_1/wordrecg.o
    ...
    $CC $COMP_FLAGS -Ibuild -c build/3_1/pbraces.c -o build/3_1/pbraces.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/trees.c -o build/3_1/trees.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/trees.c -o build/3_1/trees.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/passes.c -o build/3_1/passes.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/passes.c -o build/3_1/passes.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/treetab.c -o build/3_1/treetab.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/treetab.c -o build/3_1/treetab.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/saturate.c -o build/3_1/saturate.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/saturate.c -o build/3_1/saturate.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/guards.c -o build/3_1/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/guards.c -o build/3_1/guards.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/cgendata.c -o build/3_1/cgendata.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/cgendata.c -o build/3_1/cgendata.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/parseopt.c -o build/3_1/parseopt.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/parseopt.c -o build/3_1/parseopt.o
    echo "$LINKER -o bin/nimrod  \
build/3_1/nimrod.o \
build/3_1/system.o \
...
build/3_1/docgen2.o \
build/3_1/service.o \
build/3_1/parseopt.o $LINK_FLAGS"
    $LINKER -o bin/nimrod  \
build/3_1/nimrod.o \
build/3_1/system.o \
build/3_1/commands.o \
...
build/3_1/parseopt.o $LINK_FLAGS
  ...
  amd64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/crc.c -o build/3_2/crc.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/crc.c -o build/3_2/crc.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/nversion.c -o build/2_2/nversion.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/nversion.c -o build/2_2/nversion.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/idents.c -o build/3_2/idents.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/idents.c -o build/3_2/idents.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/intsets.c -o build/3_2/intsets.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/intsets.c -o build/3_2/intsets.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/wordrecg.c -o build/3_2/wordrecg.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/wordrecg.c -o build/3_2/wordrecg.o
    ...
    $CC $COMP_FLAGS -Ibuild -c build/3_2/pbraces.c -o build/3_2/pbraces.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/trees.c -o build/3_2/trees.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/trees.c -o build/3_2/trees.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/passes.c -o build/3_2/passes.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/passes.c -o build/3_2/passes.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/treetab.c -o build/3_2/treetab.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/treetab.c -o build/3_2/treetab.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/saturate.c -o build/3_2/saturate.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/saturate.c -o build/3_2/saturate.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/guards.c -o build/3_2/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/guards.c -o build/3_2/guards.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/cgendata.c -o build/3_2/cgendata.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/cgendata.c -o build/3_2/cgendata.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/parseopt.c -o build/3_2/parseopt.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/parseopt.c -o build/3_2/parseopt.o
    echo "$LINKER -o bin/nimrod  \
build/3_2/nimrod.o \
build/3_2/system.o \
...
build/3_2/docgen2.o \
build/3_2/service.o \
build/3_2/parseopt.o $LINK_FLAGS"
    $LINKER -o bin/nimrod  \
build/3_2/nimrod.o \
build/3_2/system.o \
build/3_2/commands.o \
...
build/3_2/parseopt.o $LINK_FLAGS
  ...
  powerpc64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/times.c -o build/3_3/times.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/times.c -o build/3_3/times.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/posix.c -o build/3_2/posix.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/posix.c -o build/3_2/posix.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/nversion.c -o build/2_2/nversion.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/nversion.c -o build/2_2/nversion.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/condsyms.c -o build/3_3/condsyms.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/condsyms.c -o build/3_3/condsyms.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/ast.c -o build/3_3/ast.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/ast.c -o build/3_3/ast.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/idents.c -o build/3_3/idents.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/idents.c -o build/3_3/idents.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/intsets.c -o build/3_3/intsets.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/intsets.c -o build/3_3/intsets.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/idgen.c -o build/3_2/idgen.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/idgen.c -o build/3_2/idgen.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/trees.c -o build/3_3/trees.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/trees.c -o build/3_3/trees.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/memfiles.c -o build/3_2/memfiles.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/memfiles.c -o build/3_2/memfiles.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/treetab.c -o build/3_3/treetab.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/treetab.c -o build/3_3/treetab.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/guards.c -o build/3_3/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/guards.c -o build/3_3/guards.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/cgendata.c -o build/3_3/cgendata.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/cgendata.c -o build/3_3/cgendata.o
...
build/3_2/parseopt.o $LINK_FLAGS
  ...
  arm)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/times.c -o build/3_4/times.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/times.c -o build/3_4/times.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/posix.c -o build/3_1/posix.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/posix.c -o build/3_1/posix.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_1/nversion.c -o build/2_1/nversion.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_1/nversion.c -o build/2_1/nversion.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/condsyms.c -o build/3_4/condsyms.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/condsyms.c -o build/3_4/condsyms.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/ast.c -o build/3_4/ast.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/ast.c -o build/3_4/ast.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/idents.c -o build/3_4/idents.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/idents.c -o build/3_4/idents.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/intsets.c -o build/3_4/intsets.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/intsets.c -o build/3_4/intsets.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/idgen.c -o build/3_1/idgen.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/idgen.c -o build/3_1/idgen.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/trees.c -o build/3_4/trees.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/trees.c -o build/3_4/trees.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/memfiles.c -o build/3_1/memfiles.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/memfiles.c -o build/3_1/memfiles.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/treetab.c -o build/3_4/treetab.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/treetab.c -o build/3_4/treetab.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/guards.c -o build/3_4/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/guards.c -o build/3_4/guards.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/cgendata.c -o build/3_4/cgendata.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/cgendata.c -o build/3_4/cgendata.o
...
solaris) 
  ...
  i386)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_1/guards.c -o build/4_1/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_1/guards.c -o build/4_1/guards.o
...
build/2_1/parseopt.o $LINK_FLAGS
  ...
  amd64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_2/guards.c -o build/4_2/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_2/guards.c -o build/4_2/guards.o
...
build/2_2/parseopt.o $LINK_FLAGS
  ...
  powerpc64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/parseutils.c -o build/3_3/parseutils.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/parseutils.c -o build/3_3/parseutils.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_3/times.c -o build/4_3/times.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_3/times.c -o build/4_3/times.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/posix.c -o build/3_2/posix.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/posix.c -o build/3_2/posix.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_3/guards.c -o build/4_3/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_3/guards.c -o build/4_3/guards.o
...
build/2_2/parseopt.o $LINK_FLAGS
  ...
  arm)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_4/parseutils.c -o build/3_4/parseutils.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_4/parseutils.c -o build/3_4/parseutils.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_4/times.c -o build/4_4/times.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_4/times.c -o build/4_4/times.o
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_1/posix.c -o build/3_1/posix.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_1/posix.c -o build/3_1/posix.o
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_4/guards.c -o build/4_4/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_4/guards.c -o build/4_4/guards.o
...
freebsd) 
  ...
  i386)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/5_1/guards.c -o build/5_1/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/5_1/guards.c -o build/5_1/guards.o
...
build/2_1/parseopt.o $LINK_FLAGS
  ...
  amd64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/5_2/guards.c -o build/5_2/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/5_2/guards.c -o build/5_2/guards.o
...
build/2_2/parseopt.o $LINK_FLAGS
  ...
  powerpc64)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/5_3/guards.c -o build/5_3/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/5_3/guards.c -o build/5_3/guards.o
...
build/2_2/parseopt.o $LINK_FLAGS
  ...
  arm)
    ...
    echo "$CC $COMP_FLAGS -Ibuild -c build/5_4/guards.c -o build/5_4/guards.o"
    $CC $COMP_FLAGS -Ibuild -c build/5_4/guards.c -o build/5_4/guards.o
