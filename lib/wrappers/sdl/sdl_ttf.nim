...
const 
  ...
  StyleBold* = 0x00000001
  StyleItalic* = 0x00000002
  StyleUnderline* = 0x00000004 # ZERO WIDTH NO-BREAKSPACE (Unicode byte order mark)
  UnicodeBomNative* = 0x0000FEFF
  UnicodeBomSwapped* = 0x0000FFFE
...
proc renderUNICODESolid*(font: PFont, text: PUInt16, fg: TColor): PSurface{.
...
proc renderUNICODEShaded*(font: PFont, text: PUInt16, fg: TColor, 
                               bg: TColor): PSurface{.cdecl, 
...
proc renderUNICODEBlended*(font: PFont, text: PUInt16, fg: TColor): PSurface{.
