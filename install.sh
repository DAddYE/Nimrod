...
if [ $# -eq 1 ] ; then
  ...
  cp lib/copying.txt $libdir/copying.txt
  chmod 644 $libdir/copying.txt
  ...
  cp lib/wrappers/libffi.nim $libdir/wrappers/libffi.nim
  chmod 644 $libdir/wrappers/libffi.nim
